...
class EventStore(object):
    ...
    def subscribe(self, _topic, _action, _handler):
        ...
        if (_topic, _action) in self.subscribers:
            ...
            subscriber = Subscriber(_topic, _action, _handler, self.redis, daemon=True)
            subscriber.start()
...
class Subscriber(threading.Thread):
    ...
    def __init__(self, _topic, _action, _handler, _redis, daemon=False):
        """
        ...
        """
        super(Subscriber, self).__init__(daemon=daemon)
        self._running = False
